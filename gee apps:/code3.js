//https://ee-celestakim018.projects.earthengine.app/view/merucounty-forestchage2015-20-25
...
var eviPalette = ['red', 'orange', 'yellow', 'lightgreen', 'green', 'darkgreen'];
...
// Add legends for LULC, Forest Change, NDVI, and EVI.
...
addLegend(eviPalette, ['Low', 'Moderate-Low', 'Moderate', 'Moderate-High', 'High', 'Very High'], 'EVI', 'top-left');

// =======================
// 10. Accuracy Assessment Display
// =======================
// Performs a standard accuracy assessment of the classifier and displays it in the app.
...
// Create UI labels for the accuracy metrics.
var accTitle = ui.Label('📊 Model Accuracy', {fontWeight: 'bold', fontSize: '14px'});
var accLabel = ui.Label(
  'Overall Accuracy: ' + overallAccuracy.getInfo().toFixed(2) +
  '\nKappa: ' + kappa.getInfo().toFixed(2),
  {whiteSpace: 'pre-wrap'}
);

// Add accuracy display to the main panel.
panel.add(accTitle);
panel.add(accLabel);
...
panel.add(chart); // Add the chart to the main panel.
...
var layersDict = {
  ...
  "EVI 2020": image2020.select('EVI').visualize({min:0.1, max:0.6, palette: eviPalette}),
